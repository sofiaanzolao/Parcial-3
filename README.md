...
El único paso manual es subir los PDFs que estan cargados en este mismo repositorio en el botón "Choose Files" que aparecerá momentos después de que empiece a correr el código.
